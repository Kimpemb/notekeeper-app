  ...
  return (
    <NodeViewWrapper as="span" className="inline" contentEditable={false}>
      <span
        ...
        className={`inline-flex items-center gap-1 px-1.5 py-0.5 mx-0.5 rounded text-xs font-medium cursor-pointer select-none transition-colors duration-100 ${exists ? "bg-blue-50 text-blue-700 hover:bg-blue-100 dark:bg-blue-950 dark:text-blue-300 dark:hover:bg-blue-900 border border-blue-200 dark:border-blue-800" : "bg-zinc-100 text-zinc-400 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-500 border border-zinc-200 dark:border-zinc-700 line-through"}`}
      >
