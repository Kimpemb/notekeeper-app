...
const CONF_HIGH_TOP    = 0.025
const CONF_HIGH_UNIQUE = 2
const CONF_HIGH_SOLO   = 0.030
const CONF_MEDIUM_TOP  = 0.015
const CONF_MEDIUM_MIN  = 3
const CONF_MEDIUM_FLOOR = 0.010
