...
interface CalendarStore {
  ...
  yellowCount:     number;                     // for sidebar badge
...
export const useCalendarStore = create<CalendarStore>()(
  persist(
    ...
    }),
    {
      ...
      // Persist view preference and layer visibility but not yellowCount
      partialize: (s) => ({
        activeView:      s.activeView,
        layerVisibility: s.layerVisibility,
        // selectedDate is intentionally NOT persisted — always open on today
      }),
    }
  )
);